...
const Product = () => {
    ...
    useEffect(()=>{
        ...
        if(id !== null)
        {
          axios.post('https://node-gaurav-ecommerce.onrender.com/product/get/', {data:{id:id}})
            .then((response) => {
              const newData = {...data};
    ...
    function submit(e){
        e.preventDefault();
        axios.post("https://node-gaurav-ecommerce.onrender.com/product/save",{data:data}).then(res=>{
