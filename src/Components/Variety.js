...
const Variety = () => {
    ...
    function load() {
        ...
        axios.post("https://node-gaurav-ecommerce.onrender.com/product/get", { data: { id: id } }).then((res) => {
    ...
    function deleteProductVariety(e, dvariety) {
        ...
        if(window.confirm("Sure to delete?")){
            axios.post("https://node-gaurav-ecommerce.onrender.com/product/deletevariety", { data: { id: id, variety: dvariety } }).then((res) => {
                load();
            })
        }
    }
    ...
    function saveVariety(e) {
        e.preventDefault();
        axios.post("https://node-gaurav-ecommerce.onrender.com/product/savevariety", { data: { id: id, variety: variety } }).then((res) => {
            load();
        });
    }
