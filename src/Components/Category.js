...
const Category = () => {
    ...
    useEffect(()=>{
        if(id !== null)
        {
          axios.post('https://node-gaurav-ecommerce.onrender.com/productcategory/get/', {data:{id:id}})
            .then((response) => {
              const newData = {...data};
    ...
    function submit(e){
        e.preventDefault();
        axios.post("https://node-gaurav-ecommerce.onrender.com/productcategory/save",{data:{
